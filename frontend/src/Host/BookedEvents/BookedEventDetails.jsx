            ...
            <div className="w-full font-montserrat">
                <div className="flex flex-col text-start mx-4 md:mx-64 shadow-md">
                    ...
                    <div className="mx-3 mt-4 flex justify-between items-center">
                       ...
                       {checkBooked === true ? <button className='text-white px-6 py-3 mt-2 font-semibold rounded bg-gray-600 hover:bg-gray-800 transition duration-300'>
                        Booked
                       </button> : <button className='text-white px-6 py-3 mt-2 font-semibold rounded bg-pink-600 hover:bg-pink-700 transition duration-300'>
                        Book
                       </button>
                       }
                    </div>
